...
\faGithub\quad\href{https://github.com/ikhanchoi/subtitle-extractor}{github.com/ikhanchoi/subtitle-extractor}\\[4pt]
\faArrowRight\quad
中国語勉強のために動画から字幕を抜き出すプログラムです。
OpenCVとeasyocrを使い、srtを抽出することができました。
